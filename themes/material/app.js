...
document.write('<link rel="stylesheet" href="//cdn.jsdelivr.net/combine/gh/zbllx/goindex-drive/cdn/plyr.css">');
// markdown support
...
function nav(path) {
    ...
    <a href="https://github.com/zbllx/goindex-drive" target="_blank" class="mdui-btn mdui-btn-icon mdui-ripple mdui-ripple-white" mdui-tooltip="{content: 'GoIndex Drive on Github'}">
